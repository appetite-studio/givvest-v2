...
export const Header = () => {
  ...
  return (
    <div className="sticky top-3 z-30 mx-4 sm:mx-6">
      {/* ── Header bar ── */}
      ...
      {mobileOpen && (
        <div className="lg:hidden mt-2 bg-white border border-[#e8e6e0] rounded-2xl overflow-hidden animate-fade-in-up">
          {/* Nav links */}
          ...
          {/* Social links */}
          <div className="px-6 pb-6 pt-4 border-t border-[#e8e6e0]">
