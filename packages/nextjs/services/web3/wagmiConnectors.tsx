...
import { baseAccount, metaMaskWallet } from "@rainbow-me/rainbowkit/wallets";
...
const wallets = [metaMaskWallet, baseAccount, ...(showBurnerWallet ? [rainbowkitBurnerWallet] : [])];
...
export const wagmiConnectors = () => {
  ...
  return connectorsForWallets(
    ...
    // RainbowKit requires a projectId parameter even when no WalletConnect wallets are used.
    { appName: "Givvest", projectId: "unused" },
  );
};
